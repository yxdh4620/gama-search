...
(function() {
  var SearchManager, con, config, debug, options, owner_id, search, should, singleItem, table_name;
  ...
  describe("url_encode test", function() {
    ...
    describe("insert tests", function() {
      return it('insert single', function(done) {
    ...
    return describe('search tests', function() {
      it("search id test", function(done) {
        return search.searchById('id', owner_id, function(err, data) {
          return done();
        });
      });
      return it("search default test", function(done) {
        return search.search('搜索', owner_id, function(err, data) {
          return done();
        });
      });
    });
