...
(function() {
  var SearchManager, con, config, debug, fieldName, model_name_1, model_name_2, mulitItem, options, owner_id_1, owner_id_2, search, should, singleItem, table_name;
  ...
  describe("search test", function() {
    ...
    return describe('search tests', function() {
      it("search multi id test", function(done) {
        return search.searchByMultipleId("id:'989541712' OR id:'992232784'", null, function(err, data) {
          console.log("err:" + err);
          console.dir(data);
          if ((data || {}).status === "OK") {
      ...
      it("search default test", function(done) {
        return search.search('a', fieldName, null, 1, 2, function(err, data) {
      ...
      return it("advancedSearch tests", function(done) {
        ...
        return search.advancedSearch('呼', fieldName, 1, {
          filter: ['kind', 'a'],
          sort: 'score'
        }, {
          fetch_fields: ['aid', 'score', 'search_name']
        }, 2, function(err, data) {
          console.error("error:" + err);
          console.dir(data);
          if ((data || {}).status === "OK") {
